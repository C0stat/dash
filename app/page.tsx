...
export default function InvestmentDashboard() {
  ...
  const [investInicial, setInvestInicial] = useState(2000);
  const [aporteMensal, setAporteMensal] = useState(0);
  const [aporteSazonal, setAporteSazonal] = useState(0);
  const [mesSazonal, setMesSazonal] = useState(0);
  ...
  const [n1, setN1] = useState(0); // Investidores já existentes
  const [n2, setN2] = useState(0);
  const [n3, setN3] = useState(0);
  const [mostrarGraficoRede, setMostrarGraficoRede] = useState(false);
  const [investInicialIndicado, setInvestInicialIndicado] = useState(1000);
  const [aporteMensalIndicado, setAporteMensalIndicado] = useState(0);
  const [aporteSazonalIndicado, setAporteSazonalIndicado] = useState(0);
